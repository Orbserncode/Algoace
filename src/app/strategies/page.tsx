...
import { getStrategies, Strategy } from '@/services/strategies-service'; // Import service and type
...
export default function StrategiesPage() {
    ...
    const handleAddNewStrategy = () => {
        ...
        toast({ title: "Feature Not Implemented", description: "Functionality to manually add a new strategy is not yet available. Use the automated generator." });
    };
    ...
    const handleStrategyDelete = useCallback((deletedStrategyId: string) => {
     ...
     // Callback for when a new strategy is generated by the form
    const handleStrategyGenerated = useCallback((newStrategy: Strategy) => {
        setStrategies(prevStrategies => [...prevStrategies, newStrategy]);
        // Optionally scroll to the table or highlight the new row
         toast({
  ...
  return (
    <div className="space-y-6">
      ...
      <Card id="automated-generation">
        ...
        <CardContent>
           <AutomatedGenerationForm onStrategyGenerated={handleStrategyGenerated} />
        </CardContent>
      </Card>
    </div>
  );
